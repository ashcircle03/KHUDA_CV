...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "tableChangeEnterThreshold": 0.035,
    "tableChangeExitThreshold": 0.020,
    "tableStaticThreshold": 0.012,
    "tableStaticConfirmSeconds": 10,
    "seatedPersonOverlap": 0.12,
    "seatedHipYRatio": 0.62,
    "seatedHeightWidthRatioThreshold": 2.35,
    "minPersonToRoiWidthRatio": 0.28,
    "maxPersonToRoiHeightRatio": 1.75,
    "standingBottomExcessRatio": 0.18,
    "standingHeightRatio": 1.05,
...
SETTING_RULES: dict[str, SettingRule] = {
    ...
    "leftGraceSeconds": SettingRule(int, 0, 3600),
    ...
    "seatedHipYRatio": SettingRule(float, 0, 1),
    "seatedHeightWidthRatioThreshold": SettingRule(float, 0.5, 10),
    "minPersonToRoiWidthRatio": SettingRule(float, 0, 5),
    "maxPersonToRoiHeightRatio": SettingRule(float, 0.1, 10),
    "standingBottomExcessRatio": SettingRule(float, 0, 5),
    "standingHeightRatio": SettingRule(float, 0.1, 10),
